...
CALL sp_test( @t_now, @t_version ); -- 내부적으로 실행돼서 t_now와 t_version에 들어감
SELECT @t_now, @t_version ; -- 으로 실행

-- Parameter 없는 StoredProcedure
...
/* 사원번호를 입력 받아서 부서이름과 부서위치를 출력하시오*/
DELIMITER $$
